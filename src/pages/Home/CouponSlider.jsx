...
const copyCouponCode = (code) => {
  ...
  return (
    <div className="my-8 container mx-auto w-full bg-background border-border p-6 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-center mb-6 text-text-primary">Trending Coupons</h2>
        ...
        >
          ...
          {groupedCoupons.map((group, index) => (
            ...
            {group.map((coupon) => (
              <div
                key={coupon._id}
                className="bg-cardback relative shadow-md rounded-lg p-6 transition-transform transform hover:scale-105"
              >
                <button
                ...
                <h3 className="text-xl font-bold text-text-primary mb-4">{coupon.code}</h3>
                <p className="text-sm text-text-light mb-3">{coupon.description}</p>
