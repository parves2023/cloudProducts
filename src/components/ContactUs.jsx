...
const ContactUs = () => {
  ...
  const images = [
    {
      ...
      description: "Empowering your tech journey to achieve success and growth.",
    },
    {
    ...
    },
    {
      ...
      description: "Create an impression with modern and professional solutions.",
    },
    {
      src: "https://www.thewebsurgery.com/wp-content/uploads/2015/02/Web-Design-London-The-Web-Surgery.jpg",
      alt: "Web Design",
      title: "Modern Web Design",
      description: "Crafting beautiful digital experiences with cutting-edge design.",
    },
  ];
  ...
  return (
    <section className="py-12 px-4 lg:px-24 bg-gray-50">
      {/* Page Heading */}
      <motion.h1
        className="text-4xl font-bold text-center mb-8 text-[#135D66]"
